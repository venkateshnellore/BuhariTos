...
<<<<<<< HEAD
    for(var i=0;i<this.menu.length;i++){
      if(this.menu[i].category == "Best Sellers"){
        for(var j=0;j<this.menu[i].items.length;j++){
          this.bestseller.push(this.menu[i].items[j])
        }
      }
    }
    console.log("Item list for best sellers", JSON.stringify(this.bestseller)); 
=======
  ...
  for( var i=0 ;i<this.category.length;i++){
    if(this.category[i].category == "Best Sellers" ){
       this.bestsellers.push(this.category[i].items);
      //  this.items = this.bestsellers;
    }
    for(var j=0; j<this.items.length;i++){
      if(this.category[0].items == "items"){
  ...
  // console.log("best sellers",JSON.stringify(this.bestsellers));
    console.log("bestsellers",this.bestsellers);
    // console.log("bestsellers",this.bestsellersitems);

// this.items=this.bestsellers[i].items;
